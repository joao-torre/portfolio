...
(function () {
  const translations = {
    pt: {
      ...
      "skills.data.desc": "SQL, Python, Pandas, Oracle e Amazon Athena para extração, tratamento e análise de dados.",
      "skills.modern.title": "Dados Modernos & Cloud",
      "skills.modern.desc": "Microsoft Fabric, AWS, S3 e Athena para soluções modernas de dados e analytics.",
    ...
    en: {
      ...
      "skills.data.desc": "SQL, Python, Pandas, Oracle and Amazon Athena for data extraction, preparation and analytics.",
      "skills.modern.title": "Modern Data & Cloud",
      "skills.modern.desc": "Microsoft Fabric, AWS, S3 and Athena for modern data and analytics solutions.",
